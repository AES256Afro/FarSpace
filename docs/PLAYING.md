...
- **People aboard:** [Shipmates](#shipmates) · [The galley](#the-galley) · [Life on the deck](#life-on-the-deck) · [A life aboard](#a-life-aboard) · [Crew arcs](#crew-arcs) · [Second stories](#second-stories) · [A trade of their own](#a-trade-of-their-own) · [The crew want a word](#the-crew-want-a-word) · [Reviews](#reviews) · [The roster](#the-roster) · [Watches and passengers](#watches-and-passengers) · [Receptions](#receptions) · [An inspection](#an-inspection) · [Alert status](#alert-status) · [The belt](#the-belt) · [Hard burn](#hard-burn) · [Medical runs](#medical-runs) · [Envoys](#envoys) · [Requests from the lounge](#requests-from-the-lounge) · [Corridor talk](#corridor-talk) · [Senior staff](#senior-staff) · [The sim rig](#the-sim-rig) · [Company](#company) · [Cards after watch](#cards-after-watch) · [The band](#the-band) · [The viewport and the bays](#the-viewport-and-the-bays) · [Rites of passage](#rites-of-passage) · [The guestbook](#the-guestbook) · [Lost property](#lost-property) · [Family](#family) · [Lost and found](#lost-and-found) · [Company](#company) · [Belonging](#belonging) · [Small kindnesses](#small-kindnesses) · [Keepsakes](#keepsakes)
...
- **Keeping:** [Legacy](#legacy) · [The chronicle room](#the-chronicle-room) · [The chronicle's week](#the-chronicles-week) · [Writing back](#writing-back)
...
pilots in your system see your ship. Autosave runs on every dock and jump;
CLOUD: CREATE SAVE CODE lets you continue on another machine.
...
- **Rare goods** (marked +) are made at one station each and are worth more the
  further you carry them.
- Watch the MISSIONS tab for the daily contract and the weekly community goal
  (a sales premium at one station type).
- Illegal goods (marked *) fence at black markets in Veil and pirate-heavy hubs;
  elsewhere customs may seize a sale.
- Fit a Cargo Rack, park a second hull with K in SHIPS, and name your ship
  with N.

## Explorer

- Every arrival logs the system (nav log). Hold V in-system for a detailed
  scan, survey worlds from orbit, and be first to a system for a first
  discovery tag everyone sees.
- Sell exploration data at the SURVEY tab; research posts pay 25% more.
- Fit a Fuel Scoop and refuel from stars (watch the heat bar), a Discovery
  Scanner to log systems fully on arrival, and a Surface Scanner for faster,
  richer orbital surveys. The Albatross Explorer hull has the scanner built in.
...
- Point at a rock and hold the mining key. Prospector Limpets read a rock's
  yield; some rich rocks are **cores** that only a seismic charge (C) opens.
- A Refinery turns part of every rock into metals; Collector Limpets pull the
  loot in.
- Rocks drop **materials** (iron, nickel, carbon, germanium, vanadium,
  polonium). Spend them at the ENGINEER tab of research and refinery stations
  on permanent upgrades: jump range, drives, scoop, mining, cargo, shields,
...
- Pick a 2-5 letter tag on the title screen. Members rank together on the WIRE
  tab, /s talks on the squadron channel anywhere, and kills near a wingmate
  are shared.
- Pooled standing makes the best squadron a faction's **patron**: members trade
  like allies and get half-price yards there.
- Fund the treasury from the BASE tab of any station and buy a civilian
  station as your **base**: shared vault, half-price (or free, with a Fuel
...
- Fares leave things in the cabin now and then: a scarf, a harmonica, a
  pocket chess set mid-game, a tin of real coffee. The passenger seat aboard
  lists what's there. Hand it in at any harbourmaster's office on the
  promenade: the office where they got off has them on file and pays 50
...
- E at the study with two or more crew aboard calls a briefing, once a leg:
  engines, sickbay, helm and tactical each report in a line (wear and the
  worst system, the cots and morale, fuel and the plotted course, shields and
  the board), and you set a focus until the next dock. Engines: wear accrues
  20% slower. Sickbay: morale +4 now and the sick mend twice as fast.
  Tactical: shields recharge half again as fast. Helm: the next jumps cost
  10% less fuel. The HUD shows the focus; the clamp clears it.

## The sim rig

- A furnishing from any shipyard (700 credits), by the study: an environment
  rig. E at the study, once a leg, picks a program: the beach (the cat hunts a
  crab that isn't there), frontier town (you lose the duel to the piano
  player; the gunner keeps the hat), the opera house (the fares dress up from
...
- The sixth program is the pictures: an old film, the whole crew, the same
  jokes at the same lines. Morale up, the fares' mood up, and every bond
  aboard a little closer.
...
- At mess call, eating at the galley with the crew now sits you with whoever
  is nearest: they talk about home, their loyalty goes up, once a week each,
  and there's a deed the first time.
...
- Dock somewhere with standing (rep 20 or more with the station's faction)
  and now and then, once a week per faction, the harbourmaster meets you at
  the clamp in a clean jacket: a reception in your honour on the upper ring.
  Make a speech (short is good; there's a chance you thank the cat), bring a
  gift from the hold (a unit of luxuries; the host owns several already), or
  plead a long day. Rep moves accordingly, the crew are insufferable about a
  good speech for a day, and there's a deed in it.

## An inspection

- At commodore and up, a reception is sometimes an inspection instead: the
  harbourmaster and somebody with more braid than you and a tablet. Four
  marks: wear under forty, crew morale sixty or better, at least two
  furnishings on the deck, the hull at seventy percent or more. Three of
  four is a good ship (rep up a lot, a deed); two is adequate; less is "we'll
  be in touch". Or plead a quarantine, which nobody believes.
...
- Y in flight cycles the alert. Yellow: shields recharge half again as fast
  ...
  and a point of morale off everyone every half minute you hold it. Green
  stands them down; so does the clamp.

## The belt

- Mining and refinery stations are the belt: low spin, low ceilings, water
  ration, scrubber filters at cost, and a tannoy that says so. Share water
...
- The singers and the quiet ones teach a word with each contact. The wall of
  ...
  one to the gate.
- Run a rock's rings under par or for the record and the rock's kids cheer
...
- The ready room's lines now cover the cadet, a prisoner with no gunner, the
  ship's quiet leg, a wake still owed, and the crew's pick.
...
- The clinic on the promenade is a menu: treat the sick, or buy burn juice at
  150 credits a dose, three aboard at most. In flight, HARD BURN on the pause
...
- Some lounges have an envoy waiting: a treaty between this station's faction
  and the destination's, in a case, on a deadline. Land them within their
  patience (one docking more than the hops) and without the hull taking fire,
...
- Customs can't open a treaty ship: with an envoy aboard, the inspection card
  ...
  the hold. There's a deed for it.
...
## The crew want a word

- Run the crew's morale low enough (under about a third, on average) and at
  the next clamp they're waiting, the lowest of them in front, the rest
  behind, nobody shouting. A bonus round (150 credits a head, morale +15,
  and they'll remember it was money), a night ashore on you (morale and
  loyalty up, the ship sits half an hour longer, a deed), or your foot down:
  half the time something settles, half the time the one in front takes the
  gangway. Once a week at most.

## Reviews

- V on the roster, with a crew member selected: a review in the study, the
  door shut, the kettle on, once a week each. Commend them (morale +8,
  loyalty +0.5, a line in the log), counsel them (morale -3, a step toward
  their next skill), or make them Number One, which the rest of the crew find
  out about within the minute. Or just talk about nothing for ten minutes,
  which is also a kind of review.
...
- Someone meets your ship at the clamp, every station, every time. They stand
  by your bay on the promenade and they've already looked the hull over: a
  hole forward, a rattle that's hours not damage, a tank on fumes, a full
  hold, fares looking green, the cat at the airlock, a scorched scoop, or a
  captain flying alone. E for their opinion.
- Once you're a regular there (five dockings) they do a small job on the house
  once a week: a plate over the worst of it, a splash in the tank, or grease
  on what rattles. The log remembers.
...
- Ten cards on the lanes and the ground with a certain flavour: a hull that
  ...
  it), a quiet world that has never launched anything and needs medicine it
  isn't supposed to know exists, a rock hopper family out of air off the
  belt, a courier's case under hard burn with juice for the crew, talent
  night in the lounge, the rec deck's sim rig stuck on a bad western, a
  diplomat without a ship, an anomaly the scanner has no name for, a place
...
- E at the galley cooks from what's aboard. Provisions always go in; a unit of
  luxuries makes it a proper dinner (more morale, and the fares' mood lifts);
  a rare tea, wine or mead aboard is poured after, and isn't used up. A crew
  member who cooks makes any of it better. Every meal patches five hull and
  feeds a passenger who asked for a hot meal.
