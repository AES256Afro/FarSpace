...
| Flight record | Complete status, objectives, contract terms and all retained messages with ReaderOverlay search and paging. | Preserve world pause, cleanup and caller tests. | Native forty long messages, final paragraph, search, full world snapshot and NPC identity passed. |
