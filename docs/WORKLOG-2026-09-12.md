...
Release verification: b0c12a5649666558d656b175c766c20c975e4f7d, v0.279.0.
CI 34703785022 passed, including Cloudflare deployment; container publication
34703784919 passed. Hosted health returns ok and the title shows v0.279.0.
Hosted index-BGOQal_8.js matches local SHA-256
3db36f313804c4003ecb5ae8a282922dde241f7132823107ec511133ccf4ac7e.
The hosted settings defaults and Minimal selection work. Critical hull/fuel
remain visible after Settings, and clicking Record opens a paused reader with
hidden status retained. No browser warnings/errors. A final local keyboard
check verified density/opacity adjustment and autopilot retention on return.
Temporary viewport override was reset. Local dev5199 runs v0.279.0 in session
74653. Browser gameplay fixtures were closed; the initial failed localhost
tab is temporary and uses the browser's automatic cleanup.
