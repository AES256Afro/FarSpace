...
const SECTIONS: [string, string[]][] = [
  ["FLIGHT", [
    ...
    "E DOCK / JUMP / ORBIT / BOARD / PLANT OR TEND A BEACON  T HAIL  TAB SYSTEM MAP  G GALAXY MAP  I SHIP",
  ]],
  ["HELPING SHIPS", ["E NEAR A STRICKEN FREIGHTER: BOARD AND REPAIR IT (HOLD E AT EACH SYSTEM), SEND YOUR ENGINEER,",
  ...
  ["STATIONS", [
    ...
    "SHIFT TRADES IN BULK  P WALK THE DECK  ESC UNDOCK  BAR: HIRE CREW, TAKE FARES (CABINS FOR THREE)",
  ...
  ["EVERYWHERE", ["F5 SAVE  F9 LOAD  H MUSIC  F FULLSCREEN  ESC BACK  FLIGHT KEYS CAN BE REBOUND IN SETTINGS", "SAVE SLOTS ON THE TITLE SCREEN: THREE LOCAL GAMES, EACH WITH ITS OWN CLOUD CODE"]],
];
